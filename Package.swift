...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(name: "TyroTapToPaySDK",
                  url: "https://tap-to-pay.connect.tyro.com/tyro/0.19.1/TyroTapToPaySDK.xcframework.zip",
                  checksum: "9879414860ca0f3323024dc1747b2bd20ba2792100429611f38b8408a2668dec"),
