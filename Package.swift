...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "TyroTapToPaySDK",
                      url: "https://tap-to-pay.connect.tyro.com/tyro/0.23.0/TyroTapToPaySDK.xcframework.zip",
                      checksum: "761517d73b5da3c35e77015c5874da34e1b748289faac48248a945d3bce1367b"),
