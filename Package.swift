...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(name: "TyroTapToPaySDK",
                  url: "https://tap-to-pay.connect.tyro.com/tyro/0.19.2/TyroTapToPaySDK.xcframework.zip",
                  checksum: "87ddc1756bd1976539f8327227df42bdd2df53faabc5bfb6d14e94ba982dd390"),
