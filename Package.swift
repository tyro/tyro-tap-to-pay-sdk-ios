...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(name: "TyroTapToPaySDK",
                  url: "https://tap-to-pay.connect.tyro.com/tyro/0.19.3/TyroTapToPaySDK.xcframework.zip",
                  checksum: "a10eba4d8c74fe2cea79c476806099534d27c93e910e3d43b82e8319a5b27cc5"),
