...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(name: "TyroTapToPaySDK",
                  url: "https://tap-to-pay.connect.tyro.com/tyro/0.19.4/TyroTapToPaySDK.xcframework.zip",
                  checksum: "8536b3ecb078e8c6686ea2bc900c8aa51185024454ec7c25cf0ee9ad2b40ec4c"),
