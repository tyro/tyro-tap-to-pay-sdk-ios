...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(name: "TyroTapToPaySDK",
                  url: "https://tap-to-pay.connect.tyro.com/tyro/0.3.0/TyroTapToPaySDK.xcframework.zip",
                 checksum: "574699006f4ca549e4392dd6c1fca4235883e0f196d404191456d1e4330233a7"),
