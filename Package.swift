...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(name: "TyroTapToPaySDK",
                  url: "https://tap-to-pay.connect.tyro.com/tyro/0.4.0/TyroTapToPaySDK.xcframework.zip",
                  checksum: "5721e244d68f0c33283725298af29749ae2b8f282cb053a2786d7d8968209420"),
