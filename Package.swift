...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(name: "TyroTapToPaySDK",
                  url: "https://tap-to-pay.connect.tyro.com/tyro/0.7.0/TyroTapToPaySDK.xcframework.zip",
                  checksum: "3a295262f750e2c28a1862d04e46c173a86b8447c89cf1a094ba6e5dbab0e4ad"),
